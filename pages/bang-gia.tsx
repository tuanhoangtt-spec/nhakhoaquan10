...
export default function BangGia() {
  return (
    <>
      <Head>
        <title>Bảng Giá Nha Khoa AVA - Nha Khoa Uy Tín Quận 10</title>
        <meta
          name="description"
          content="Bảng giá tham khảo Nha khoa AVA Quận 10: khám và tư vấn miễn phí, niềng răng, cấy ghép Implant, bọc răng sứ, trám răng, tẩy trắng răng. Cập nhật mới nhất."
        />
        <link rel="canonical" href={`${SITE_URL}/bang-gia`} />
      </Head>
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-[#F6F9EF] rounded-2xl p-6 mt-10">
          <p className="text-sm text-[#3A4F4C]">
            ...
            từng trường hợp cụ thể. Quan tâm đến{' '}
            <a href="/nieng-rang-quan-10" className="text-[#5C7A24] underline font-medium">
              niềng răng trả góp
            </a>
