// pages/case-hoan-thanh.tsx
// LƯU Ý: các case dưới đây dùng ảnh giữ chỗ (placeholder). Hãy thay src="/assets/cases/..."
// bằng ảnh thật (ảnh trước/sau đã có sự đồng ý của khách hàng) khi đưa lên chính thức.
...
export default function CaseHoanThanh() {
  return (
    <>
      <Head>
        <title>Case Đã Hoàn Thành - Nha Khoa AVA Quận 10</title>
        <meta
          name="description"
          content="Hình ảnh các ca điều trị thực tế đã hoàn thành tại Nha khoa AVA: cấy ghép Implant, niềng răng, bọc răng sứ thẩm mỹ tại Quận 10, TP.HCM."
        />
        <link rel="canonical" href={`${SITE_URL}/case-hoan-thanh`} />
      </Head>
