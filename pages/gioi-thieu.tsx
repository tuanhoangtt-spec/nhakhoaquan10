...
export default function GioiThieu() {
  return (
    <>
      <Head>
        <title>Giới Thiệu Nha Khoa AVA - Nha Khoa Uy Tín Quận 10</title>
        <meta
          name="description"
          content="Nha khoa AVA - địa chỉ duy nhất tại 283/91 Cách Mạng Tháng 8, Quận 10, TP.HCM. Giấy phép 04405/SYT-GPHĐ, đội ngũ bác sĩ chuyên môn nhiều năm kinh nghiệm."
        />
        <link rel="canonical" href={`${SITE_URL}/gioi-thieu`} />
      </Head>
